                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode('[contact-form-7 id="149" title="Form review"]')?>
                        </div>   
                    </div>
                </div>
                <div class="row mt70">
                            ...
                            <div class="glide__track" data-glide-el="track">
                                <ul class="glide__slides">
                                    <li class="glide__slide">
                                        ...
                                        Thank you very much for your politeness and patience. I only approached you with an idea for a gift, and you developed it into a full-fledged project! So now my son plays all day long with the railroad, built according to his plans)                                            <br><br>
                                        Special thanks to the manager Laurhe for her patience and persistence!    
                                    </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                            Alexei Dmitrievich Cherkessov
                                        </div>
                                        <div class="feedslider__text">
                                        Ordered a whole batch of toys from the guys for kindergarten. The New Year went off without a hitch! Now all the kids are happy and do not part with their gifts, and the most cunning ones are asking when the next holidays)
                                        </div>
                                    </li>
                                    <li class="glide__slide">
                                        <div class="feedslider__title">
                                        ...
                                        <div class="feedslider__text">
                                        I decided to order gifts for her baby's birthday here. And I don't regret it one bit! The teddy bear is exactly as I wanted, just like in my childhood: soft, pleasant to the touch and very cute. You can tell right away that he is handmade.
                                        </div>
                                    </li>
                                </ul>
                            </div>
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <div class="reply__wrapper">
                    <?php echo do_shortcode('[contact-form-7 id="150" title="Form PopUp"]')?>
                    <!-- <?php echo do_shortcode('[contact-form-7 id="149" title="Form review"]'); ?> -->
